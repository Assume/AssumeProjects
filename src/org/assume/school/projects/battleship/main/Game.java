...
public class Game
{
	...
	public static void main(String[] args)
	{
		...
		game.setupPlayer(game.getOne());
		game.setTwo(game.getTwo());
	...
	{
		AircraftCarrier.getInstance(false, p);
		BattleShip.getInstance(false, p);
		Cruiser.getInstance(false, p);
		Destroyer.getInstance(false, p);
		Submarine.getInstance(false, p);
	}
