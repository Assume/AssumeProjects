...
public class Geometry
{
	...
	try
	{
	    x = new Scanner(new File("C:\\Users\\Adam\\Documents\\test.txt"));
    ...
    public static double getAreaTrapezoid(double baseOne, double baseTwo,
	    double height)
    {
    ...
    public static double getTrianglePerimeter(double sideOne, double sideTwo,
	    double sideThree)
    {
	return sideOne + sideTwo + sideThree;
    }

    public static double getTrapezoidPerimeter(double baseOne, double baseTwo,
	    double height)
    {
    ...
    public static double getPrismVolume(double sideOne, double sideTwo,
	    double sideThree)
    {
	return sideOne * sideTwo * sideThree;
    }
    ...
    public static double[] getMidpoint(double x1, double y1, double x2,
	    double y2)
    {
	return new double[]
	{ ((x1 + x2) / 2), ((y1 + y2) / 2) };
