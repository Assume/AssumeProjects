...
public class WrapBufferedImage extends JFrame implements java.io.Serializable {

	private static final long serialVersionUID = 2553662508833989734L;
	private BufferedImage im = null;
	private int drawPointX, drawPointY;

	public WrapBufferedImage(BufferedImage im) {
		this.im = im;
	}

	public WrapBufferedImage(String filepath) {
		try {
	...
	public WrapBufferedImage(Image img) {
		this.im = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_RGB);
	...
	public java.awt.ImageCapabilities getCapabilities(java.awt.GraphicsConfiguration gs) {
